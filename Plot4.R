...
# Plot 1
plot(energy_consumed[, dateTime], energy_consumed[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(energy_consumed[, dateTime],energy_consumed[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
# Plot 4
plot(energy_consumed[, dateTime], energy_consumed[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
